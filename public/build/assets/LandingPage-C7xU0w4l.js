import{c as N,u as z,r as f,j as e,a as y,C as U,V as k,B as L,M as R,L as $,S as T,d as q}from"./index-4li0Ucku.js";import{M as C}from"./map-pin-4oZ_Y3q3.js";import{B as _}from"./book-open-BqGD66ET.js";import{U as O}from"./users-BuWpf0pz.js";import{F as P}from"./file-text-DmHFB2zy.js";import{S as V}from"./shield-Bt6e9WiP.js";import{C as G}from"./calendar-eIawqv9d.js";import{S as Y}from"./sparkles-BdzUJU_Z.js";import{G as Z}from"./graduation-cap-CWJ4bQSs.js";import{C as X}from"./check-CfMbptXm.js";/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=[["path",{d:"M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z",key:"l5xja"}],["path",{d:"M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z",key:"ep3f8r"}],["path",{d:"M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4",key:"1p4c4q"}],["path",{d:"M17.599 6.5a3 3 0 0 0 .399-1.375",key:"tmeiqw"}],["path",{d:"M6.003 5.125A3 3 0 0 0 6.401 6.5",key:"105sqy"}],["path",{d:"M3.477 10.896a4 4 0 0 1 .585-.396",key:"ql3yin"}],["path",{d:"M19.938 10.5a4 4 0 0 1 .585.396",key:"1qfode"}],["path",{d:"M6 18a4 4 0 0 1-1.967-.516",key:"2e4loj"}],["path",{d:"M19.967 17.484A4 4 0 0 1 18 18",key:"159ez6"}]],W=N("brain",H);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const J=[["line",{x1:"18",x2:"18",y1:"20",y2:"10",key:"1xfpm4"}],["line",{x1:"12",x2:"12",y1:"20",y2:"4",key:"be30l9"}],["line",{x1:"6",x2:"6",y1:"20",y2:"14",key:"1r4le6"}]],K=N("chart-no-axes-column",J);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]],ee=N("globe",Q);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const se=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]],te=N("zap",se);function ae(a){return a.toLocaleString("id-ID")}function ie({tutor:a,onView:n,onBook:u}){var p,g;const{t:r}=z(),[j,s]=f.useState(!1),v=a.subject??a.subject_label??r("findTutor.subjectGeneral"),F=a.location??a.city??r("findTutor.online"),m=r("findTutor.experienceYears",{years:a.experience_years??0}),w=a.level_label??a.level??r("findTutor.allLevels"),E=ae(a.price??a.price_per_hour??0),B=a.online??a.mode_online??!1,h=a.badge??(a.verified?r("findTutor.topTutor"):null);return e.jsxs("div",{className:"bg-white p-3",children:[e.jsxs("div",{className:"flex gap-3",children:[e.jsxs("div",{className:"relative shrink-0",children:[a.photo&&!j?e.jsx("img",{src:a.photo,onError:()=>s(!0),alt:a.name,className:"w-[72px] h-[72px] rounded-lg object-cover bg-gray-200"}):e.jsx("div",{className:`
                w-[72px]
                h-[72px]
                rounded-lg
                bg-blue-600
                ...
                text-2xl
                font-bold
              `,children:((g=(p=a.name)==null?void 0:p.charAt(0))==null?void 0:g.toUpperCase())||"T"}),B&&e.jsx("span",{className:"absolute bottom-0 right-0 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-white"})]}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex justify-between items-start gap-2",children:[e.jsxs("div",{className:"min-w-0",children:[e.jsx("h3",{className:"font-semibold text-[18px] leading-tight text-gray-900 truncate",children:a.name}),e.jsx("p",{className:"text-sm text-slate-500 mt-1 truncate",children:v})]}),h&&e.jsx("span",{className:"text-[10px] px-2 py-1 rounded bg-blue-50 text-blue-600 whitespace-nowrap",children:h})]}),e.jsxs("div",{className:"flex items-center gap-1 mt-2",children:[e.jsx(y,{size:14,className:"fill-yellow-400 text-yellow-400"}),e.jsx("span",{className:"text-sm font-medium text-gray-900",children:a.rating??0}),e.jsxs("span",{className:"text-sm text-gray-500",children:["(",a.reviews??0,")"]})]})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-4 mt-3 pb-3 border-b border-gray-100 text-xs text-gray-500",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(C,{size:12}),e.jsx("span",{children:F})]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(U,{size:12}),e.jsx("span",{children:m})]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(_,{size:12}),e.jsx("span",{children:w})]})]}),e.jsxs("div",{className:"mt-3 flex justify-between items-center gap-2",children:[e.jsxs("div",{children:[e.jsxs("span",{className:"text-lg font-bold text-gray-900",children:["Rp ",E]}),e.jsx("span",{className:"text-[10px] text-gray-500 ml-1",children:r("findTutor.perSession")})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{onClick:n,className:`
              h-8
              px-3
              text-xs
              border
            ...
            `,children:r("findTutor.viewProfile")}),e.jsx("button",{onClick:u,className:`
              ...
              hover:bg-blue-700
              transition
            `,children:r("findTutor.bookButton")})]})]})]})}function pe({navigate:a,platformStats:n,tutors:u,user:r,onSelectTutor:j}){const{t:s}=z(),[v,F]=f.useState([]),[m,w]=f.useState(null);f.useEffect(()=>{(async()=>{try{const l="http://localhost:8000/api".replace(/\/api\/?$/,"")??"https://rezi-laravel.nlabs.id",o=await(await fetch(`${l}/api/website/ratings`)).json();if(o.data&&o.data.length>0){const b=o.data.map(i=>{const x=i.photo,S=x?x.startsWith("http")?x:`${l}/storage/${x}`:null;return{id:i.id,name:i.name,role:i.role,photo:S,text:i.text,rating:i.rating,created_at:i.created_at}}),c=b.filter(i=>i.rating===5).sort((i,x)=>!i.created_at||!x.created_at?0:new Date(x.created_at).getTime()-new Date(i.created_at).getTime()).slice(0,3);F(c),w({average:o.average??0,total:o.total??b.length})}}catch(l){console.error("Failed to fetch testimonials:",l)}})()},[]),f.useEffect(()=>{document.documentElement.style.scrollBehavior="smooth";const t={threshold:.1,rootMargin:"0px 0px -50px 0px"},l=c=>{c.forEach(i=>{i.isIntersecting&&(i.target.classList.add("animate-in","fade-in","duration-700"),d.unobserve(i.target))})},d=new IntersectionObserver(l,t);return document.querySelectorAll("section").forEach(c=>{c.style.opacity="0",d.observe(c)}),document.querySelectorAll("[class*='grid']").forEach(c=>{d.observe(c)}),()=>{d.disconnect()}},[]);const E=[{icon:e.jsx(ee,{size:24,className:"text-white"}),title:s("landing.feature1.title"),desc:s("landing.feature1.description"),gradient:"from-[#2563EB] to-[#1D4ED8]"},{icon:e.jsx(_,{size:24,className:"text-white"}),title:s("landing.feature2.title"),desc:s("landing.feature2.description"),gradient:"from-[#0EA5E9] to-[#0284C7]"},{icon:e.jsx(O,{size:24,className:"text-white"}),title:s("landing.feature3.title"),desc:s("landing.feature3.description"),gradient:"from-[#6366F1] to-[#4F46E5]"}],B=[{icon:e.jsx(k,{size:20}),title:s("landing.platformFeature1.title"),desc:s("landing.platformFeature1.description"),color:"#2563EB",bg:"#EFF6FF"},{icon:e.jsx(W,{size:20}),title:s("landing.platformFeature2.title"),desc:s("landing.platformFeature2.description"),color:"#0EA5E9",bg:"#F0F9FF"},{icon:e.jsx(C,{size:20}),title:s("landing.platformFeature3.title"),desc:s("landing.platformFeature3.description"),color:"#6366F1",bg:"#EEF2FF"},{icon:e.jsx(P,{size:20}),title:s("landing.platformFeature4.title"),desc:s("landing.platformFeature4.description"),color:"#0891B2",bg:"#ECFEFF"},{icon:e.jsx(V,{size:20}),title:s("landing.platformFeature5.title"),desc:s("landing.platformFeature5.description"),color:"#2563EB",bg:"#EFF6FF"},{icon:e.jsx(K,{size:20}),title:s("landing.platformFeature6.title"),desc:s("landing.platformFeature6.description"),color:"#0EA5E9",bg:"#F0F9FF"},{icon:e.jsx(L,{size:20}),title:s("landing.platformFeature7.title"),desc:s("landing.platformFeature7.description"),color:"#6366F1",bg:"#EEF2FF"},{icon:e.jsx(R,{size:20}),title:s("landing.platformFeature8.title"),desc:s("landing.platformFeature8.description"),color:"#0891B2",bg:"#ECFEFF"}],h=[{num:"01",icon:e.jsx($,{size:18}),title:s("landing.step1.title"),desc:s("landing.step1.description"),color:"#2563EB"},{num:"02",icon:e.jsx(T,{size:18}),title:s("landing.step2.title"),desc:s("landing.step2.description"),color:"#0EA5E9"},{num:"03",icon:e.jsx(G,{size:18}),title:s("landing.step3.title"),desc:s("landing.step3.description"),color:"#6366F1"},{num:"04",icon:e.jsx(k,{size:18}),title:s("landing.step4.title"),desc:s("landing.step4.description"),color:"#0891B2"},{num:"05",icon:e.jsx(y,{size:18}),title:s("landing.step5.title"),desc:s("landing.step5.description"),color:"#2563EB"}],p=u.filter(t=>t.role==="tutor").length,g=t=>t>=1e3?`${t.toLocaleString("id-ID")}+`:t.toLocaleString("id-ID"),A=p>0?g(p):n!=null&&n.total_tutors?g(n.total_tutors):"—",D=n!=null&&n.total_students?g(n.total_students):"—",M=[{val:A,label:s("landing.stats.tutors")},{val:D,label:s("landing.stats.students")},{val:"50+",label:s("landing.stats.cities")},{val:"95%",label:s("landing.stats.satisfaction")}],I=[...u].sort((t,l)=>(l.rating??0)-(t.rating??0)).slice(0,3);return e.jsxs("div",{className:"bg-white text-gray-900",style:{scrollBehavior:"smooth"},children:[e.jsx("style",{children:`
        html {
